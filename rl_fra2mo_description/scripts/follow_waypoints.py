...
def main():
    ...
    def create_pose(transform):
        ...
        # Converti RPY in quaternionetransform
    ...
    #waypoint_order = [3, 2, 1, 0]  # Obiettivo 3 → Obiettivo 4 → Obiettivo 2 → Obiettivo 1
    
    waypoint_order = [1, 2, 3, 4, 5]
    ...
    for i, goal_pose in enumerate(goal_poses):
        ...
        print(goal_poses[i].pose.position)
